		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		  	...
		  	<div class="carousel-inner">
		    	<div class="carousel-item active img-slider">
		      		<img src="assets/img/slide-1.png" class="d-block w-100 img-slide" alt="">
		      		<div class="carousel-caption d-none d-md-block top-left ps-4">
			        	...
			        	<small>Ingin menjadi agen / owner ???</small><br> 
			    		<a href="login.php" class="btn btn-blue me-2" style="width: 150px;">LOGIN</a><a href="register.php" class="btn btn-register" style="width: 150px;">REGISTER</a>
	...
	<div class="container p-4">
		<div class="row">
			<div class="col-lg-6">
				<img src="assets/img/bg-3.png" style="max-width: 100%;">
			</div>
