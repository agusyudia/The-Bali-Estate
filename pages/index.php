...
<head>
    ...
    <title>The Bali Estate - Admin Page</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php 
                ...
                {
                   echo'
                        <li class="nav-item"><a class="nav-link" href="?page=pemilik&aksi=view"><i class="fas fa-fw fa-users"></i><span>Pemilik</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="?page=agen&aksi=view"><i class="fas fa-fw fa-user"></i><span>Agen</span></a></li>
                        <li class="nav-item"><a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                                aria-expanded="true" aria-controls="collapsePages"><i class="fas fa-fw fa-folder"></i><span>Property</span></a>
                            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <h6 class="collapse-header">Property Yang Ada :</h6>
                                    <a class="collapse-item" href="?page=property&aksi=view">Rumah</a>
                                    <a class="collapse-item" href="1">Villa</a>
                  ...
                  echo'
                        ...
                        <li class="nav-item">
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                                aria-expanded="true" aria-controls="collapsePages"><i class="fas fa-fw fa-folder"></i><span>Property</span>
                            </a>
                            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <h6 class="collapse-header">Property Yang Ada :</h6>
                                    <a class="collapse-item" href="?page=property&aksi=view">Rumah</a>
                                    <a class="collapse-item" href="2">Villa</a>
                                    <a class="collapse-item" href="">Tanah</a>
                                    <a class="collapse-item" href="">Apartemen</a>
                                    <a class="collapse-item" href="#">Gudang</a>
                                    <a class="collapse-item" href="#">Hotel</a>
                        ...
                        <li class="nav-item">
                            ...
                            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item" href="3">Tanah</a>
                                    <a class="collapse-item" href="">Apartemen</a>
                                    <a class="collapse-item" href="#">Gudang</a>
                                    <a class="collapse-item" href="#">Hotel</a>
                                    <a class="collapse-item" href="#">Kost</a>
                        ...
                        $aksi = $_GET['aksi'];    
                                if ($page == "agen") {
                                  ...
                                  if ($aksi == "view") {
                                    ...
                                    include "pemilik-detail.php";
                                  }else if ($aksi == "edit") {
                                    include "pemilik-edit.php";
                                  }else if ($aksi == "rincian") {
                                    include "pemilik-rincian.php";
                                  }else if ($aksi == "delete") {
