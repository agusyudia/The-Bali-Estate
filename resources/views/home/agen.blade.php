...
<html lang="en">
				...
				<form>
					<div class="form-row d-flex">
						<div class="input-group flex-fill p-2 ms-4">
							<input type="text" class="form-control p-3" placeholder="cari lokasi agen sesuai dengan property yang anda inginkan" aria-label="Recipient's username" aria-describedby="basic-addon2">
	...
	<div class="container pt-4">
		<div class="row p-4">
			...
			@foreach($agen->slice(0, 4) as $agen)
			<div class="col-lg-3 p-2">
				<div class="card text-center">
				  	<img class="card-img-top" src="{{ asset('image/agen/' . $agen->image) }}" alt="Card image cap" style="max-height: 300px !important;">
				 	<div class="card-body">
				    	<h5 class="card-title blue">{{$agen -> nama_agen}}</h5>
				    	<p class="card-text">{{$agen -> keterangan}}</p>
				 	</div>
						<ul class="list-group list-group-flush">
						    <li class="list-group-item">{{$agen -> perusahaan}}</li>
						    <li class="list-group-item"><span class="fa fa-map blue"></span> {{$agen -> lokasi}}</li>
						    <li class="list-group-item">{{$agen -> no_tlp}}</li>
						    <li class="list-group-item">Memiliki  : 20</li>
						    <li class="list-group-item">Terjual : 8</li>
						</ul>
				 	<div class="card-body">
				    	<a href="" target="_blank" class="btn btn-outline-primary"><span class="fa fa-phone"></span>  Hubungi</a>
				    	<a href="{{ route('agendetail',$agen->id) }}" class="btn btn-outline-primary">Detail</a>
				  	</div>
				</div>
			</div>
			@endforeach
