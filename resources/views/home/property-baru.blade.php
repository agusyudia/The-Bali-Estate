...
<html lang="en">
					    	...
					    	<div class="col-md-6">
					    		<a href="" class="nav-link item">
						      		<div class="card-body p-0 ps-1 pt-2 pb-1 h-card">
						        		<h5 class="card-title"><b>Rumah Badung</b></h5>
						        		<p class="card-text">
						        			This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer
						        			<label><span class="fa fa-map blue"></span>    Dalung Permai Blok JJ no.14</label>
						        		</p>
						        		<p class="card-text">
						        			<span class="fa fa-bed text-info p-1"></span>2
						        			<span class="fa fa-bath text-info p-1"></span>3
	...
	<div class="container-fluid bg-abu pt-4 pb-4">
		<div class="container">
			<div class="row p-3">
				<div class="p-2">
					<p style="color: #00B978;">Update Property</p>
					<h1><b>New Promo Property</b></h1>
				</div>
				<div class="col-lg-6 pt-2">
					<div class="card">
					    		...
					    		<a href="" class="nav-link item-list">
						      		<div class="card-body p-0 ps-2 pt-2 p-1">
						        		...
						        		<p class="card-text">
						        			<span class="bg-green-card pt-1 pb-1 ps-3 pe-3">House</span>
						        			<span class="bg-red-card pt-1 pb-1 ps-3 pe-3">Spesial</span>
						        			<span class="bg-blue-card pt-1 pb-1 ps-3 pe-3">Dic 35%</span>
						        		</p>
						        		<p class="card-text">Rp. 100.000.000.000</p>
						      		</div>
					      		</a>
					    		...
					    		<a href="" class="nav-link item-list">
						      		<div class="card-body p-0 ps-2 pt-2 p-1">
						        		...
						        		<p class="card-text">
						        			<span class="bg-green-card pt-1 pb-1 ps-3 pe-3">House</span>
						        			<span class="bg-red-card pt-1 pb-1 ps-3 pe-3">Spesial</span>
						        			<span class="bg-blue-card pt-1 pb-1 ps-3 pe-3">Dic 25%</span>
						        		</p>
						        		<p class="card-text">Rp. 100.000.000.000</p>
						      		</div>
					      		</a>
